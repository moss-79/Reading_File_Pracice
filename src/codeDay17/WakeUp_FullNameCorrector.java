...
public class WakeUp_FullNameCorrector {
    ...
    public static void main(String[] args) {
        ...
        String firstNameCorrected = firstName.toUpperCase().substring(0, 1) + firstName.toLowerCase().substring(1, 4);

        System.out.print("firstNameCorrected = " + firstNameCorrected);
