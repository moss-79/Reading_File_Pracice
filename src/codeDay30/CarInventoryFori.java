...
public class CarInventoryFori {
    public static void main(String[] args) {
      ...
      String[] cars ={  "Acura-NSX",
        ...
        // task 2 : print all lacation of civic
        for (int x = 0; x < cars.length; x++) {
            if (cars[x].contains("Chevrolet-Colorado")){
                System.out.println("Chevrolet-Colorado " + x);
            }
        }
       ...
       /* String eachCar = "Honda-Civic";
        ...
        System.out.println("car make is  = " + eachCarSplit[0]+
                " And car model is "+ eachCarSplit[1]);*/
        for (String eachCar :
                cars) {
