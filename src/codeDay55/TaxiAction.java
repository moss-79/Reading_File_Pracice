...
public class TaxiAction {
    public static void main(String[] args) {
        ...
        Driver dr = new Driver("Moss",2358);
        Taxi t1 = new Taxi(67000,en,dr);
...
//        System.out.println("Driver name " + y.name );
        System.out.println("Driver name " + t2.dri.name);
        ...
        System.out.println("Driver name first char " + t2.dri.name.charAt(0));
